...
\newcommand{\hwName}{Homework 1: Background Material}
\newcommand{\dueDate}{Tuesday, May 24 at 1:00 PM}
...
% No longer using special instructions for HW 1
\section*{START HERE: Instructions}
\begin{itemize}
\item \textbf{Collaboration policy:} Collaboration on solving the homework is allowed, after you have thought about the problems on your own. It is also OK to get clarification (but not solutions) from books or online resources, again after you have thought about the problems on your own. There are two requirements: first, cite your collaborators fully and completely (e.g., ``Jane explained to me what is asked in Question 2.1''). Second, write your solution {\em independently}: close the book and all of your notes, and send collaborators out of the room, so that the solution comes from you only.  See the Academic Integrity Section on the course site for more information: \url{https://www.cs.cmu.edu/~hchai2/courses/10601/#Syllabus}
...
\begin{parts}
    \part[1] \sone Assignments turned in late without prior approval will incur a daily penalty. How much is the penalty? Up to 1 day: \underline{\hspace{0.5cm}} Up to 2 day: \underline{\hspace{0.5cm}} Up to 3 day:
    ...
    \part[1] \sone How many grace days do you have in total for all homework? Can you combine grace days with late days to extend a homework submission deadline by 4 days?
    ...
    \begin{checkboxes}
        ...
        \choice Post on Ed at least 4 days before the homework deadline
...
\textbf{\underline{Use the following data to answer questions 1}}. Consider data created by flipping a coin five times $S $ = [1, 1, 0, 1, 0] , where 1 denotes that the coin turned up heads and 0 denotes that it turned up tails. \bigskip

\begin{parts}
    
    \part[2] \sone What is the probability of observing any combination of this data (3 heads and 2 tails), assuming it was generated by flipping a coin X with an unequal probability of heads (1) and tails (0), where the distribution is $P(X = 1) = 0.6$, $P(X = 0) = 0.4$?
    
    \begin{checkboxes}
        % YOUR ANSWER
        \choice $\frac{1024}{3125}$
        \CorrectChoice $\frac{216}{625}$
        \choice $\frac{162}{625}$
        \choice $\frac{1}{32}$
    \end{checkboxes}
    ...
    \part[1] \sone For some events $A_{1}, A_{2}, \dots, A_{n}$, $$P(A_{1} \cup A_{2} \cup \dots \cup A_{n}) \leq P(A_1) + P(A_2) + \dots + P(A_n)$$
...
\clearpage
    ...
    \clearpage
    \textbf{\underline{Use the following information to answer questions 8-11}}. Let $X$ be a random variable with expected value $E[X] = 1$ and variance $Var[X] = 2$. 
    ...
    \clearpage
    \textbf{\underline{Use the following information to answer questions 12-15:}}
    ...
    \begin{your_solution}[height=2cm, width=4cm]
        \begin{center}\huge N/A \end{center}
        \end{tcolorbox}\hspace{2cm}
    \end{your_solution}
    ...
    \begin{your_solution}[height=2cm, width=4cm]
        \begin{center}\huge 0 \end{center}
        \end{tcolorbox}\hspace{2cm}
    \end{your_solution}
    ...
    \begin{enumerate}[label=\Alph*)]
        \item  $P(X=x) = \frac{1}{\sqrt{(2\pi)^d |\sum|}}\exp\left(-\frac{1}{2}(x - \mu)^T\sum^{-1}(x-\mu)\right)$
...
\begin{parts}
    ...
    \part[2] Evaluate the derivative of y with respect to x, where $y = \ln\left(\frac{4}{x^3}-x^2\right)$ at x = 1.

    \begin{your_solution}[height=2cm, width=4cm]
        \begin{center}\huge -14/3 \end{center}
        \end{tcolorbox}\hspace{2cm}
    \end{your_solution}
...
\begin{parts}
    ...
    \part[1] \sone Consider the matrix $\mathbf{X}$ and the vectors $\mathbf{y}$ and $\mathbf{z}$ below: \textbf{X}=$\begin{bmatrix} 3 & 5 \\ 7 & 9 \end{bmatrix}$, \textbf{y}=$\begin{bmatrix} 3 \\ 7 \end{bmatrix}$, \textbf{z}=$\begin{bmatrix} 6 \\ 5 \end{bmatrix}$. What is the inner product (dot product) of the vectors \textbf{y} and \textbf{z}? 

    \begin{checkboxes}
        % YOUR ANSWER
        % Change \choice to \CorrectChoice for the appropriate selection/selections 
        \choice $\begin{bmatrix} 18 & 15 \\ 42 & 35 \end{bmatrix}$
        \choice 57
        \choice $\begin{bmatrix} 18 \\ 35 \end{bmatrix}$
        \CorrectChoice 53
    \end{checkboxes}


    \part[1] \sone Using the same values for \textbf{X}, \textbf{y}, and \textbf{z} as above, what is the product \textbf{Xy}?

    \begin{checkboxes}
        % YOUR ANSWER
        % Change \choice to \CorrectChoice for the appropriate selection/selections 
        \choice $\begin{bmatrix} 9 & 35 \\ 21 & 63 \end{bmatrix}$
        \CorrectChoice $\begin{bmatrix} 44 \\ 84 \end{bmatrix}$
        \choice $\begin{bmatrix} 58 \\ 78 \end{bmatrix}$
        \choice $\begin{bmatrix} 9 & 15 \\ 49 & 63 \end{bmatrix}$
    \end{checkboxes}
...
\clearpage
    ...
    \part[1] \sone The matrix $\mathbf{A}$ from the previous question has an inverse.
    ...
    \part[2] \sone Consider two vectors $\xv = \begin{bmatrix} x_1 \\ x_2 \\ x_3 \end{bmatrix}$ and $\yv = \begin{bmatrix} y_1 \\ y_2 \\ y_3 \end{bmatrix}$ and let $z = \xv^T \yv$. What is $\frac{\partial z}{\partial x_2}$? 
    ...
    \begin{checkboxes}
        ...
        \CorrectChoice The solution must be wrong because the eigenvectors are linearly dependent.
    ...
    \part[2] \sall Consider $\Av = \begin{bmatrix} 0 & 0 & 0 \\ -7 & -1 & -4 \\ 3 & 0 & 1\end{bmatrix}$ and $\xv = \begin{bmatrix} 1 \\ 0\\ 0 \end{bmatrix}$. Which of the following is true for $\Av$ and $\xv$? \\
    ...
    \begin{checkboxes}
        % YOUR ANSWER
        % Change \emptysquare to \filledsquare for the appropriate selection/selections 
        \choice 0 is an eigenvalue of $\Av$
        \CorrectChoice 0 is an eigenvalue of $\Av^T$
        \CorrectChoice $\xv$ is an eigenvector of $\Av$
        \CorrectChoice $\xv$ is an eigenvector of $\Av^T$
        \choice None of the above
    \end{checkboxes}
    }
...
\begin{parts}
    ...
    \begin{checkboxes}
        ...
        \choice depends on the value of $\xv$
    \end{checkboxes}
    ...
    \begin{checkboxes}
        % YOUR ANSWER
        % Change \emptycircle to \filledcircle for the appropriate selection/selections 
        \CorrectChoice The inner product $\mathbf{w^T(x' - x'')}$, where $\mathbf{x'}$ and $\mathbf{x''}$ are two points on the line $\mathbf{w^Tx}+b=0$, is 0
...
\begin{parts}
    \part[1] \sone If $f(n)=3^{n}$ and $g(n)=2^{n}$ which of the following are true?
    ...
    \begin{your_solution}[height=2cm, width=\textwidth]
        \begin{center}\huge1,2,3,5,6,4,7,8,9,10\end{center}
        \end{tcolorbox}\hspace{2cm}
    \end{your_solution}
    ...
    \begin{your_solution}[height=2cm, width=\textwidth]
        \begin{center}\huge1,2,7,3,4,8,5,6,9,10\end{center}
        \end{tcolorbox}\hspace{2cm}
    \end{your_solution}
    ...
    \begin{your_solution}[height=1.5cm, width=\textwidth/2]
        \begin{center}\huge node.val == key \end{center}
        \end{tcolorbox}\hspace{2cm}
    \end{your_solution}
    ...
    \begin{your_solution}[height=1.5cm, width=\textwidth/2]
        \begin{center}\huge find_val(node.leftNode, key)\end{center}
        \end{tcolorbox}\hspace{2cm}
    \end{your_solution}
    \clearpage
    ...
    \begin{your_solution}[height=1.5cm, width=\textwidth/2]
        \begin{center}\huge find_val(node.rightNode, key)\end{center}
        \end{tcolorbox}\hspace{2cm}
    \end{your_solution}
    ...
    \begin{your_solution}[height=1.5cm, width=\textwidth/2]
        \begin{center}\huge result\end{center}
        \end{tcolorbox}\hspace{2cm}
    \end{your_solution}
    ...
    \[ M_n = \begin{cases} 
          2 & \text{if } n = 0\\
          1 & \text{if } n = 1\\
          M_{n-1} + M_{n-2} & \text{if } n > 1
       \end{cases}
    \]
    
    \part[2] \sone Which of the following is the numerical value for $M_{32}$? 
...
\begin{your_solution}[height=6cm]
    \begin{center}\huge 1. no, 2. no, 3.no\end{center}
    \end{tcolorbox}\hspace{2cm}
\end{your_solution}
